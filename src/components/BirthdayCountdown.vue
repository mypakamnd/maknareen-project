<template>
  <div id="countdown">
    <div class="scroll-down">
      <a class="scroll-down-btn" href="#donation-total" v-smooth-scroll></a>
    </div>
    <nav class="menu-nav">
      <a class="menu-title" href="#donation-total" v-smooth-scroll
        >Donation Total</a
      >
...
#countdown {
  ...
  align-items: center;
  height: 100svh;
  background-image: url("../../assets/landscapeBackground3.jpg");
